...
<div class="row">
    ...
    <form action="{{url('blocks/edit/'.$id)}}" class="form-horizontal" id="validation-form" method="post" enctype="multipart/form-data">
...
$(document).ready(function(){
      //$('.wysihtml5').wysihtml5();
          ...
          $('#title-form').html($('#title').val());

          $('#button').html($('#name-link-form').val());
          //replace data on 9
          $('#title-form').blur(function(){
            $('#title').html($(this).val());
          });
