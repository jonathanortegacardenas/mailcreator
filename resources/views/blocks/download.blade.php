...
<head>
    ...
    @if($id==2289)
        <script type="text/javascript">
           window.location.href="http://sensibus.udla.edu.ec/";
        </script>
    @endif
	                          ...
	                          <table align="center" border="0" cellspacing="0" cellpadding="0" >
	                            <tr>
	                              <td  style="font-size: 12px; line-height: 27px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; color:#ffffff; font-weight:300; text-align:center;" >
	                                  <span style="text-decoration: none; color: #ffffff;"><a href="{{asset('/view/'.$id)}}" style="text-decoration: none; color: #ffffff; ">Ver On-line</a></span>
	                              </td>
	                      ...
	                      <table  border="0"  align="right" cellpadding="0" cellspacing="0"  class="container2" >
	                        ...
	                        <tr>
	                         ...
	                         <td valign="top" align="center"  >
	                          ...
	                          <table  border="0"  align="center" cellpadding="0" cellspacing="0" class="container" >
	                            <tr><td  colspan="4" align="center" valign="middle"  id="clear-padding" style="color:#ffffff;"> Síguenos en:</td></tr>
                                <tr>
                                  ...
                                  <td   align="center" valign="middle"  id="clear-padding">
	                                ...
	                                @else
                                    <a href="https://www.instagram.com/udlaecuador/"><img src="{{asset('img/icon-instagram.png')}}" width="22" alt="icon-instagram" style="max-width:22px;" border="0" hspace="0" vspace="0"/></a>
                                    @endif
                                  </td>
	                            </tr>
	                          </table>
	                  ...
	                  <tr>
	                    ...
	                    <table align="left" border="0" cellspacing="0" cellpadding="0" class="container2" >
	                      ...
	                      <tr>
	                        <td  align="center" valign="top"  >
	                           <a href="#">
                               @if($campaign->logo=='rojo.png'||$campaign->logo=='blanco.png')
                                    <img  src="{{asset('img/'.$campaign->logo)}}"  width="114" style="max-width:114px;"  alt="Logo" border="0" hspace="0" vspace="0"/>
                               @else
                                    <img  src="{{asset('uploads/'.$campaign->logo)}}"  width="114" style="max-width:114px;"  alt="Logo" border="0" hspace="0" vspace="0"/>
                               @endif
                               </a>
	                        </td>
	                          ...
	                          <tr>
	                            <td style="font-size: 13px;  line-height: 18px; color: #a3a2a2;  font-weight:300; text-align: center; font-family:Roboto,Open Sans,Arail,Tahoma, Helvetica, Arial, sans-serif;">
	                              ...
	                              foreach($menus as $menu){ ?>
	                                <span style="text-decoration: none; color: #a3a2a2;"><a href="<?php echo $menu->url ?>" style="text-decoration: none; color: #a3a2a2; "><?php echo $menu->nombre ?></a></span>  &nbsp;&nbsp; 
	                              <?php } ?>
	                            </td>
	                          </tr>
	                        </table>
	                  ...
	                  <tr>
	                    <td valign="top" align="center" >
	                      ...
	                      <table  border="0"  align="center" cellpadding="0" cellspacing="0" style="table-layout: fixed;">
	                        <tr><td colspan="4" style="color: #727272;text-align: center;font-size: 18px;padding-bottom: 10px;">S&iacute;guenos en:</td></tr>
                            <tr>
	                          ...
	                          <td  style="padding-left:5px;" height="30" align="center" valign="middle"  class="clear-padding">
	                            <a href="https://www.youtube.com/{{$campaign->youtube}}">
	                              <img src="{{asset('img/icon-youtube-color.png')}}" width="22" alt="icon-youtube" style="max-width:22px;" border="0" hspace="0" vspace="0"/>
	                            </a>
	                          </td>
                              <td  style="padding-left:5px;" height="30" align="center" valign="middle"  class="clear-padding">
                                @if($campaign->instagram!='')
                                    <a href="https://www.instagram.com/{{$campaign->instagram}}"><img src="{{asset('img/icon-instagram-color.png')}}" width="22" alt="icon-instagram" style="max-width:22px;" border="0" hspace="0" vspace="0"/></a>
                                @else
                                    <a href="https://www.instagram.com/udlaecuador/"><img src="{{asset('img/icon-instagram-color.png')}}" width="22" alt="icon-instagram" style="max-width:22px;" border="0" hspace="0" vspace="0"/></a>
                                @endif
	                          </td>
                            </tr>
	                      </table>
